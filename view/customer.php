...
<div id="main">
    ...
    <div class="content">
        ...
        <div class="card mt-3">
            <div class="card-body">
                <a href="../view/add_customer_view.php" class="btn btn-primary mb-3">Thêm khách hàng mới</a>
                    ...
                    <?php if (!empty($customers)): ?>
                        <?php foreach ($customers as $customer): ?>
                            <tr>
                                ...
                                <td>
                                    <a href="../view/update_customer_view.php?id=<?php echo $customer['id']; ?>" class="btn btn-sm btn-primary">Sửa</a>
                ...
                .then(data => {
                    ...
                    if (data.error) {
                        ...
                        data.customers.forEach(customer => {
                            ...
                            <td>
                                <a href="../view/update_customer_view.php?id=${customer.id}" class="btn btn-sm btn-primary">Sửa</a>
