...
<div id="main">
    ...
    <div class="content">
        ...
        <?php endif; ?>
        <!-- Thông báo thành công khi cập nhật chương trình khuyến mãi -->
        <?php if (isset($_GET['flash_sale_updated']) && $_GET['flash_sale_updated'] === 'success'): ?>
            <div class="alert alert-success" role="alert">
                Cập nhật chương trình khuyến mãi thành công!
            </div>
        <?php endif; ?>
        <!-- Thông báo thành công khi xóa chương trình khuyến mãi -->
        <?php if (isset($_GET['flash_sale_deleted']) && $_GET['flash_sale_deleted'] === 'success'): ?>
            <div class="alert alert-success" role="alert">
        ...
        <div class="card mt-3">
            <div class="card-body">
                <a href="../controllers/FlashSaleController.php?action=add" class="btn btn-primary mb-3">Thêm chương trình khuyến mãi mới</a>
                <a href="apply_flash_sale.php" class="btn btn-secondary mb-3">Áp dụng chương trình khuyến mãi</a>
                    ...
                    <?php if ($result->num_rows > 0): ?>
                        <?php while ($row = $result->fetch_assoc()): ?>
                            ...
                            <tr>
                                ...
                                <td><?php echo htmlspecialchars(intval($row['discount'])); ?></td>
                                <td><?php echo htmlspecialchars($row['start_date']); ?></td>
                                <td><?php echo htmlspecialchars($row['end_date']); ?></td>
                                <td><?php echo $status_text; ?></td>
                                <td>
                                    <a href="../controllers/FlashSaleController.php?action=update&id=<?php echo $row['id']; ?>" class="btn btn-sm btn-primary">Sửa</a>
                                    <a href="../controllers/FlashSaleController.php?action=delete&id=<?php echo $row['id']; ?>" class="btn btn-sm btn-danger" onclick="return confirm('Bạn có chắc chắn muốn xóa chương trình khuyến mãi này?');">Xóa</a>
                                </td>
                            </tr>
                        <?php endwhile; ?>
                    <?php else: ?>
                        <tr>
                            <td colspan="7" class="text-center">Không có chương trình khuyến mãi nào.</td>
                        </tr>
                    <?php endif; ?>
                    </tbody>
                </table>
