...
<div id="main">
    ...
    <div class="content">
        ...
        <div class="card mt-3">
            <div class="card-body">
                <a href="add_flash_sale.php" class="btn btn-primary mb-3">Thêm chương trình khuyến mãi mới</a>
                    ...
                    <?php if ($result->num_rows > 0): ?>
                        <?php while ($row = $result->fetch_assoc()): ?>
                            ...
                            <tr>
                                ...
                                <td>
                                    <a href="update_flash_sale.php?id=<?php echo $row['id']; ?>" class="btn btn-sm btn-primary">Sửa</a>
                                    <a href="delete_flash_sale.php?id=<?php echo $row['id']; ?>" class="btn btn-sm btn-danger" onclick="return confirm('Bạn có chắc chắn muốn xóa chương trình khuyến mãi này?');">Xóa</a>
                                </td>
                            </tr>
                        <?php endwhile; ?>
                    <?php else: ?>
